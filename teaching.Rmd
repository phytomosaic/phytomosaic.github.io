...
2022 Winter  
**Community Structure and Analysis, BOT-570.**  Instructor of record.  4 credits.  Graduate-only, 16 students.  Quantitative methods for the analysis of biotic communities, including community concepts, estimation of community composition parameters, theoretical aspects of multivariate methods of analyzing species-importance data, and overview of multivariate tools; hands-on computer analysis of data sets.  
\  
...
<center><img src="images/fig_wawawai.png" style="border:0; margin-right: 15px; margin-left: 15px;" width="65%" alt="" align="middle"></center>
