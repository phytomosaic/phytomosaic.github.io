...
Through distributed experiments, open-source software development and large-scale national forest inventories, we ask:  
...
How does community-level vulnerability emerge from climatic constraints of single species?  We are developing [statistical indices](./images/vuln_equations.pdf) that integrate the climatic exposure of any site with the collective sensitivities of species that occur there.  Find the [source code here](https://github.com/phytomosaic/vuln){target="_blank"} .  Findings so far challenge the myth of "extremophile" lichens: those in hot, low-latitude sites are frequently close to exceeding the critical thermal limits that signal compositional shifts in forest ecosystems.
</br>
</div>
